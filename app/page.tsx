...
import { ArrowRight, Camera, Clock, MessageSquare, Star } from "lucide-react"
        ...
        <div className="container mx-auto px-4 py-20 md:py-32 flex flex-col items-center gap-12 relative z-10">
          ...
          >
            ...
            <motion.h1 className="text-4xl md:text-6xl font-bold leading-tight" variants={fadeInUp}>
              Crafting Memories Into <span className="text-red-200">Beautiful Albums</span>
            </motion.h1>
            <motion.p className="text-lg md:text-xl text-red-100 max-w-xl mx-auto" variants={fadeInUp}>
              Since 2018, we've been creating affordable, professional photo albums that exceed expectations.
            </motion.p>
            <motion.div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center" variants={fadeInUp}>
            ...
            {[
              {
                ...
                description:
                  "Preserve your special day with our premium wedding albums, designed to capture every precious moment.",
              },
              {
                icon: Clock,
                title: "Family Portraits",
                description:
                  "Create lasting family memories with our custom-designed portrait albums that tell your unique story.",
              },
              {
                icon: MessageSquare,
                title: "Special Events",
                description:
                  "From birthdays to anniversaries, our special event albums capture the joy and celebration of your milestones.",
              },
            ].map((service, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl font-bold text-red-900">Featured Albums</h2>
            <Link href="/albums" className="text-red-600 hover:text-red-700 font-medium flex items-center mt-4 md:mt-0">
              View All Albums
          ...
          >
            {[
              ...
              { title: "Anniversary Special", desc: "Celebrating love stories" },
            ].map((album, index) => (
              <motion.div
                key={index}
                className="group"
      ...
      <section className="py-20 bg-gradient-to-br from-red-50 to-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-red-900">What Our Clients Say</h2>
          ...
          >
            {[
              ...
              >
                {/* Quote mark */}
                <div className="absolute top-4 right-4 text-4xl text-red-100 font-serif">"</div>
                ...
                <div className="flex items-center mb-4">
                  {[...Array(5)].map((_, starIndex) => (
                    ...
                    >
                      <Star
                        className={`h-4 w-4 ${
                          starIndex < testimonial.stars ? "text-yellow-400 fill-yellow-400" : "text-gray-300"
                        }`}
                      />
                    </motion.div>
                  ))}
                  <span className="ml-2 text-sm text-slate-500">({testimonial.stars}/5)</span>
                </div>

                <p className="text-slate-600 mb-6 relative z-10 leading-relaxed">{testimonial.quote}</p>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      <h4 className="font-semibold text-red-900 text-sm">{testimonial.name}</h4>
        ...
        <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
              Join thousands of satisfied customers and bring your memories to life with our premium photo albums.
            </motion.p>
            <motion.form
