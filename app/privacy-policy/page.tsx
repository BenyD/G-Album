          ...
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            >
              ...
              <p className="text-red-700 text-sm mb-0">
                This Privacy Policy describes how G Album collects, uses, and
            ...
            >
              <section>
                ...
                <ul className="list-disc pl-6 mb-4 space-y-2">
                  ...
                  <li>
                    Usage data (pages visited, time spent on site, click
                    patterns)
                  </li>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 mb-4 space-y-2">
                  <li>
                    ...
                    vendors who help us operate our business (payment
                    processors, shipping companies, printing services)
                  </li>
                  <li>
